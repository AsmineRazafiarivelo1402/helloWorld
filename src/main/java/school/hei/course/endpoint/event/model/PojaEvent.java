package school.hei.course.endpoint.event.model;

import static java.lang.Math.random;
import static school.hei.course.endpoint.event.EventStack.EVENT_STACK_1;
...
import school.hei.course.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    if (getEventStack().equals(EVENT_STACK_1)) return "school.hei.course.event1";
    return "school.hei.course.event2";
  }
}
