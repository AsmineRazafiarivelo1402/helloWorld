package school.hei.course.endpoint.event.consumer;
...
import school.hei.course.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("school.hei.course.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "school.hei.course.service.event."
